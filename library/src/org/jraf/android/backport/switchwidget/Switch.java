...
public class Switch extends CompoundButton {
    ...
    public Switch(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.bt_switchStyle);
    }
    ...
    public Switch(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTrackDrawable = a.getDrawable(R.styleable.Switch_bt_track);
        mTextOn = a.getText(R.styleable.Switch_textOn);
        mTextOff = a.getText(R.styleable.Switch_textOff);
        mThumbTextPadding = a.getDimensionPixelSize(R.styleable.Switch_bt_thumbTextPadding, 0);
        mSwitchMinWidth = a.getDimensionPixelSize(R.styleable.Switch_bt_switchMinWidth, 0);
        mSwitchPadding = a.getDimensionPixelSize(R.styleable.Switch_bt_switchPadding, 0);

        final int appearance = a.getResourceId(R.styleable.Switch_bt_switchTextAppearance, 0);
        if (appearance != 0) {
